...
List<Recipe> recipes = [
  ...
  Recipe(
      ...
      image: 'assets/quinoa_bowl.jpg',
      description:
      " A nutritious and flavorful quinoa bowl with roasted vegetables, avocado, and a tahini dressing.",
      servings: "3",
      mealtype: "lunch",
      duration: '40',
      ingredients: [
      ...
      instructions: [
        ...
        "Preheat the oven to 400°F (200°C). Roast sweet potato, zucchini, and red bell pepper on a baking sheet for 25-30 minutes.",
        "In a bowl, assemble cooked quinoa, roasted vegetables, sliced avocado, and chopped cilantro.",
        "Drizzle with tahini dressing and toss gently.",
      ],
      favourite: false),
  Recipe(
      title: 'Beef Stroganoff',
      image: 'assets/beef_stroganoff.jpg',
      description:
      " A comforting and creamy beef stroganoff with tender strips of beef, mushrooms, and a rich sour cream sauce served over egg noodles.",
      servings: "4",
      mealtype: "Dinner",
      duration: '45',
      ingredients: [
      ...
      instructions: [
        "In a large skillet, heat 1 tablespoon of butter over medium-high heat. Add the thinly sliced beef and cook until browned. Remove beef from the skillet and set aside..",
        "In the same skillet, add another tablespoon of butter. Sauté onions and garlic until softened.",
        "Add sliced mushrooms and cook until they release their moisture and become tender.",
        "Sprinkle flour over the mushroom mixture and stir well to combine. Cook for 2-3 minutes to eliminate the raw flour taste.",
        "Gradually whisk in beef broth and Worcestershire sauce, stirring constantly until the mixture thickens.",
        "Reduce heat to low and return the cooked beef to the skillet. Stir in sour cream and season with salt and pepper to taste.",
        "Simmer gently for 10-15 minutes until the flavors meld.",
